...
const mediaAritmetica = (...numbers) => {
    let media = numbers.reduce((acumulador, valorAtual) => acumulador + valorAtual, 0)
    let somaIndice = numbers.length
    let mediaNum = media / somaIndice
    return mediaNum
 }

 console.log(mediaAritmetica(5, 5, 5, 5, 5))
